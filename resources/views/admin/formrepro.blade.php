   ...
   <head>
	 ...
	 <link href="https://cdn.datatables.net/responsive/2.2.3/css/responsive.dataTables.min.css" rel="stylesheet">
      ...
      <div class="container w-full mx-auto px-2">
			...
			SOLICITUDES DE EXCEPCIÓN RECHAZADAS
            </h1>
...
$bd =mysqli_select_db ($coneccion, $basededatos);
  ...
  $codigo = " SELECT s.id, s.comentario, u.apellidos_usu, u.codigo_usu, t.nom_tiposolicitud, te.nom_tipoexcepcion, o.nom_opciones, s.fecha_solicitud, s.fechainicio, s.fechafin, s.estado, s.fecharespuesta
  FROM usuario AS u, solicitud AS s, tiposolicitud AS t, tipoexcepcion AS te, opcioneslista AS o
   WHERE s.estado = '0' AND s.id_usuario = u.id AND s.id_tipoexcepcion = te.id_tipoexcepcion AND s.id_opcioneslista = o.id_opcioneslista AND s.id_tiposolicitud = t.id_tiposolicitud AND s.destino='0' AND t.nom_tiposolicitud = 'Excepciones'";
