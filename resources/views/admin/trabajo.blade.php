                ...
                <table id="example" class=" text-center stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
                    ...
                    <thead>
						...
						<tr>
                            ...
                            <th data-priority="5">DESCRIPCION DE SOLICITUD</th>
...
$bd =mysqli_select_db ($coneccion, $basededatos);
  ...
  $codigo = "
  SELECT s.id, u.apellidos_usu, u.codigo_usu, t.nom_tiposolicitud, s.fecha_solicitud, s.fechainicio, s.fechafin, s.estado, s.comentario, s.fecharespuesta FROM usuario AS u, solicitud AS s, tiposolicitud AS t WHERE s.estado = '2' AND s.id_usuario = u.id AND s.id_tiposolicitud = t.id_tiposolicitud AND t.nom_tiposolicitud = 'Certificado de trabajo' ORDER BY s.fecha_solicitud ASC";
...
?>
						<tr>
						<form method="GET" action="{{'trabajoaceptar'}}">
