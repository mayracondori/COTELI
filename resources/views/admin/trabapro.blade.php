...
<html lang="en" class="antialiased">
   ...
   <body class="bg-gray-100 text-gray-900 tracking-wider leading-normal">
      ...
      <div class="container w-full md:w-3/5 xl:w-3/5  mx-auto px-2">
			...
			SOLICITUDES CERTIFICADO DE TRABAJO APROBADOS
            </h1>
