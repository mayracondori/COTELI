...
<html lang="en" class="antialiased">
   ...
   <body class="bg-gray-100 text-gray-900 tracking-wider leading-normal">
      ...
      <div class="container w-full md:w-4/5 xl:w-4/5  mx-auto px-2">
			...
			SOLICITUDES BOLETAS PENDIENTES
            </h1>
                ...
                <table id="example" class=" text-center stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
                    ...
                    <thead>
						...
						<tr>
							...
							<th data-priority="2">TIPO DE SOLICITUD</th>
							<th data-priority="3">FECHA SOLICITUD</th>
...
$bd =mysqli_select_db ($coneccion, $basededatos);
  ...
  $codigo = "
  SELECT s.id, u.apellidos_usu, u.codigo_usu, t.nom_tiposolicitud, te.nom_tipoexcepcion, o.nom_opciones, s.fecha_solicitud, s.fechainicio, s.fechafin, s.estado, s.fecharespuesta FROM usuario AS u, solicitud AS s, tiposolicitud AS t, tipoexcepcion AS te, opcioneslista AS o WHERE s.estado = '2' AND s.id_usuario = u.id AND s.id_tipoexcepcion = te.id_tipoexcepcion AND s.id_opcioneslista = o.id_opcioneslista AND s.id_tiposolicitud = t.id_tiposolicitud AND t.nom_tiposolicitud = 'Boleta de pago' ORDER BY s.fecha_solicitud ASC ";
...
?>
						<tr>
						<form method="GET" action="{{'bolaceptar'}}">
