...
$bd =mysqli_select_db ($coneccion, $basededatos);
        ...
        $codigo2 = " SELECT u.id, u.nombres_usu,u.apellidos_usu,u.codigo_usu,g.nom_gerencia FROM usuario u, gerencia as g WHERE u.id_gerencia= g.id_gerencia and u.codigo_usu=$codigoeva ";
...
<BR></BR>
       ...
       <tbody>
              ...
              <input required type="text" name= "gerencia2" id="gerencia2">
              
              <select required name="departamento2" id="departamento2"></select>
                    </td>
            ...
            <tr class="bg-gray-50 w-full">
                   ...
                   <tr>
                    <td  class="p-2 w-full border-r">
                        <textarea  name="Fortaleza_eva" id="Fortaleza_eva" cols="185" rows="2" placeholder=" Debe incluir las fortalezas de su evaluado. Por ejemplo : Liderazgo, perseverancia, etc."></textarea>
                    </td>               
                ...
                <tr class="bg-gray-50 w-full">
                   ...
                   <tr>
                    <td  class="p-2 w-full border-r">
                        <textarea  name="Debilidad_eva" id="Debilidad_eva" cols="185" rows="2" placeholder=" Debe incluir las debilidades de su evaluado. Por ejemplo : Impuntualidad, impaciencia, etc."></textarea>
                    </td>               
...
$(document).ready(function(){
  function loadDepartamen2(){

          var id_gerencia2 =$('#gerencia2').val();

              $.get('departamentos2',{id_gerencia2: id_gerencia2},function(departamentos2){
                var old = $('#departamento2').data('old') != '' ? $('#departamento2').data('old') : '';
              $('#departamento2').empty();
             // $('#departamento').append( "<option value=''>El usuario es: </option>");
              $.each(departamentos2,function(index,value){
                $('#departamento2').append("<option value='" + index + "'" + (old == index ? 'selected' : '') + ">" + value +"</option>");
    ...
    loadDepartamen2();
    $('#gerencia2').on('change',loadDepartamen2);
    $('#gerencia2').on('keyup',loadDepartamen2);
});
