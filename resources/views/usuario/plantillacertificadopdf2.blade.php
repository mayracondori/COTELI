...
@csrf
      ...
      <img src="https://pagos.cotel.bo/assets/admin/img/login.png" width="150" style="margin: 0px 0px 0px 500px; " >
      <?php
...
position: absolute;
">
  <img src="https://pagos.cotel.bo/assets/admin/img/login.png" width="550" style="margin: 50px 400px 300px 100px; " >
