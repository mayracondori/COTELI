...
<BR></BR>
       ...
       <tbody>
              ...
              <input required type="text" name= "gerencia1" id="gerencia1">
              
              <select required name="departamento1" id="departamento1"></select>
                    </td>
...
$(document).ready(function(){
  function loadDepartamen(){

          var id_gerencia1 =$('#gerencia1').val();

              $.get('departamentos1',{id_gerencia1: id_gerencia1},function(departamentos1){
                var old = $('#departamento1').data('old') != '' ? $('#departamento1').data('old') : '';
              $('#departamento1').empty();
             // $('#departamento').append( "<option value=''>El usuario es: </option>");
              $.each(departamentos1,function(index,value){
                $('#departamento1').append("<option value='" + index + "'" + (old == index ? 'selected' : '') + ">" + value +"</option>");
    ...
    loadDepartamen();
    $('#gerencia1').on('change',loadDepartamen);
    $('#gerencia1').on('keyup',loadDepartamen);
});
