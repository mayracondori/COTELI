                        ...
                        <div class="bg-white rounded w-full relative z-10 py-1">
                            <ul class="list-reset">
                                ...
                                <li class="relative" x-data="{showChildren:false}" @mouseleave="showChildren=false" @mouseenter="showChildren=true">
                                    <a href="http://localhost/COTELI/public/usuario/rechazadas" class="px-4 py-2 flex w-full items-start hover:bg-gray-100 no-underline hover:no-underline transition-colors duration-100 cursor-pointer"> <span class="flex-1">Lista de mis solicitudes</span> </a>
                                </li>
                                <li class="relative" x-data="{showChildren:false}" @mouseleave="showChildren=false" @mouseenter="showChildren=true">
                                    <a href="http://localhost/COTELI/public/usuario/poraprobar" class="px-4 py-2 flex w-full items-start hover:bg-gray-100 no-underline hover:no-underline transition-colors duration-100 cursor-pointer"> <span class="flex-1">Lista de solicitudes pendientes </span> </a>
                                </li>
                                 </ul>
                        </div>
                    </div>
                    ...
                    <div class="bg-white shadow-md rounded border border-gray-300 text-sm absolute top-auto left-0 min-w-full w-56 z-30 mt-1" x-show="showChildren" x-transition:enter="transition ease duration-300 transform" x-transition:enter-start="opacity-0 translate-y-2" x-transition:enter-end="opacity-100 translate-y-0" x-transition:leave="transition ease duration-300 transform" x-transition:leave-start="opacity-100 translate-y-0" x-transition:leave-end="opacity-0 translate-y-4" style="display: none;">
                        ...
                        <div class="bg-white rounded w-full relative z-10 py-1">
                            <ul class="list-reset">
                                ...
                                <li class="relative" x-data="{showChildren:false}" @mouseleave="showChildren=false" @mouseenter="showChildren=true">
                                    <a href="http://localhost/COTELI/public/usuario/pendientes" class="px-4 py-2 flex w-full items-start hover:bg-gray-100 no-underline hover:no-underline transition-colors duration-100 cursor-pointer"> <span class="flex-1">Formal</span> </a>
                                </li>
                                <li class="relative" x-data="{showChildren:false}" @mouseleave="showChildren=false" @mouseenter="showChildren=true">
                                    <a  href="http://localhost/COTELI/public/usuario/info" class="px-4 py-2 flex w-full items-start hover:bg-gray-100 no-underline hover:no-underline transition-colors duration-100 cursor-pointer"> <span class="flex-1">Avisos</span> </a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <li class="block relative" x-data="{showChildren:false}" @click.away="showChildren=false">
                    ...
                    <div class="bg-white shadow-md rounded border border-gray-300 text-sm absolute top-auto left-0 min-w-full w-56 z-30 mt-1" x-show="showChildren" x-transition:enter="transition ease duration-300 transform" x-transition:enter-start="opacity-0 translate-y-2" x-transition:enter-end="opacity-100 translate-y-0" x-transition:leave="transition ease duration-300 transform" x-transition:leave-start="opacity-100 translate-y-0" x-transition:leave-end="opacity-0 translate-y-4" style="display: none;">
                        ...
                        <div class="bg-white rounded w-full relative z-10 py-1">
                            <ul class="list-reset">
                                <li class="relative" x-data="{showChildren:false}" @mouseleave="showChildren=false" @mouseenter="showChildren=true">
                                    <a href="http://localhost/COTELI/public/usuario/calendario" class="px-4 py-2 flex w-full items-start hover:bg-gray-100 no-underline hover:no-underline transition-colors duration-100 cursor-pointer"> <span class="flex-1">Mi calendario</span> </a>
                                </li>
                                <li class="relative" x-data="{showChildren:false}" @mouseleave="showChildren=false" @mouseenter="showChildren=true">
                                    <a href="http://localhost/COTELI/public/usuario/miscertificados" class="px-4 py-2 flex w-full items-start hover:bg-gray-100 no-underline hover:no-underline transition-colors duration-100 cursor-pointer"> <span class="flex-1">Mis certificados </span> </a>
                                </li>
                                <li class="relative" x-data="{showChildren:false}" @mouseleave="showChildren=false" @mouseenter="showChildren=true">
                                    <a href="http://localhost/COTELI/public/usuario/misreportes" class="px-4 py-2 flex w-full items-start hover:bg-gray-100 no-underline hover:no-underline transition-colors duration-100 cursor-pointer"> <span class="flex-1">Mis reportes </span> </a>
                                </li>
                 ...
                 <li class="block relative" x-data="{showChildren:false}" @click.away="showChildren=false">
                    ...
                    <div class="bg-white shadow-md rounded border border-gray-300 text-sm absolute top-auto left-0 min-w-full w-56 z-30 mt-1" x-show="showChildren" x-transition:enter="transition ease duration-300 transform" x-transition:enter-start="opacity-0 translate-y-2" x-transition:enter-end="opacity-100 translate-y-0" x-transition:leave="transition ease duration-300 transform" x-transition:leave-start="opacity-100 translate-y-0" x-transition:leave-end="opacity-0 translate-y-4" style="display: none;">
                        ...
                        <div class="bg-white rounded w-full relative z-10 py-1">
                            <ul class="list-reset">
                                <li class="relative" x-data="{showChildren:false}" @mouseleave="showChildren=false" @mouseenter="showChildren=true">
                                    <a href="http://localhost/COTELI/public/usuario/evaluacion" class="px-4 py-2 flex w-full items-start hover:bg-gray-100 no-underline hover:no-underline transition-colors duration-100 cursor-pointer"> <span class="flex-1">180°</span> </a>
                                </li>
                                <li class="relative" x-data="{showChildren:false}" @mouseleave="showChildren=false" @mouseenter="showChildren=true">
                                    <a href="http://localhost/COTELI/public/usuario/evaluaciongerente" class="px-4 py-2 flex w-full items-start hover:bg-gray-100 no-underline hover:no-underline transition-colors duration-100 cursor-pointer"> <span class="flex-1">360°</span> </a>
                                </li>
                                           ...
                                           $codigo28 = " SELECT s.id_usuario, s.estado FROM solicitud as s, usuario as u WHERE u.codigo_usu=$codigo  and u.id=s.id_usuario and s.estado=1  and s.id_opcioneslista=2 and s.updated_at='$hoy' ";
                                                  ...
                                                  if($uni==1){
                                                      ...
                                                      <?php
                                                       ...
                                                       ?> <a href="usuario/permisocumple"> <button style=" margin-left: 550px;" class='bg-orange-500 text-white font-bold py-2  rounded hover:bg-yellow-500'>Solicitar permiso cumpleaños</button> </a>
...
<?php
$hoy=date('Y-m-d');
$codigo22 = " SELECT * FROM `noificacion` WHERE fechaini<='$hoy' and fechafin>='$hoy' ";
$resultado22 = mysqli_query($coneccion, $codigo22);
while ($rest22 = mysqli_fetch_array($resultado22)) {
    $idnot=$rest22['id_noti'];
    ?>
                <a onclick="toggleModal('<?php echo 'NOTI'.$idnot;?>')" class="flex items-center px-4 py-3 border-b hover:bg-gray-100 -mx-2">
                    <img class="h-8 w-8 rounded-full object-cover mx-1" src="{{url('../img/login.png')}}">
                    <p class="text-gray-600 text-sm mx-2">
                        <span class="font-bold" href="#"> <?php echo strtoupper($rest22['titulo_noti']) ?></span> 
                    </p>
                </a>
                <div  class=" hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center" id="<?php echo 'NOTI'.$idnot;?>">
                        <div  class="relative w-auto my-6 mx-auto max-w-3xl">
                            <!--content-->
                                ...
                                <div  style="justify-content:center" class=" bg-blueGray-200 border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                 <!--header-->
                                            ...
                                            <div style="background-image:url(https://static.vecteezy.com/system/resources/previews/001/925/660/non_2x/abstract-background-party-celebration-or-special-birthday-background-vector.jpg)"class="flex items-start justify-between p-5 border-b border-solid border-blueGray-200 rounded-t">
                                                <h3 style="color:white" class="text-3xl  font-semibold ">
                                                 <?php echo strtoupper($rest22['titulo_noti']) ?>
                                                </h3>
                                                <button class="p-1 ml-auto bg-transparent border-0  opacity-5 float-right text-3xl leading-none font-semibold outline-none focus:outline-none" onclick="toggleModal('<?php echo 'NOTI'.$idnot;?>')">
                                              <span  style="color:black" class="bg-transparent  opacity-5 h-6 w-6 text-2xl block outline-none focus:outline-none">
                                                X
                                              </span>
                                              </button>
                                        ...
                                        <div  style="color:black"  style=" width:750px; height:230px;;  ;background-color:white; " class="relative p-6 flex-auto">
                                                <p class="my-4 text-blueGray-500  text-lg leading-relaxed">
                                                <?php echo $rest22['contenido_noti'];?>
             ...
             <div class="hidden opacity-25 fixed inset-0 z-40 bg-black" id="<?php echo 'NOTI'.$idnot;?>"></div>
  <?php  
}
