...
<div class="mx-auto max-w-4xl bg-white py-5 px-12 lg:px-24 shadow-xl mb-24">
    <form action="{{route('gerente.solmedico')}}" method="POST">
@csrf
    ...
    ?>
        ...
        <div class="-mx-3 md:flex mb-6">
          ...
          <div class="md:w-1/2 px-3">
            ...
            <input class="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" id="title" type="file" accept="application/pdf">
          </div>
          ...
          <div class="md:w-1/2 px-3">
            ...
            <a href="https://play.google.com/store/search?q=camscanner"><img src="https://pbs.twimg.com/profile_images/441048726933471232/GwoWB-K7_400x400.png" class="object-left-top object-scale-down h-16 w-full ">APP para convertir fotos en pdf</a>
          </div>
        ...
        <div class="-mx-3 md:flex mb-6">
          <div class="md:w-1/2 px-3 mb-6 md:mb-0">
            ...
            <input class="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" id="fechainicio" name="fechainicio" type="date" placeholder="Netboard">
          ...
          <div class="md:w-1/2 px-3">
            ...
            <input class="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" id="fechafin" name="fechafin" type="date" placeholder="Software Engineer">
          </div>
        </div>
        <div class="-mx-3 md:flex mb-6">
            <div class="md:w-1/2 px-3 mb-6 md:mb-0">
