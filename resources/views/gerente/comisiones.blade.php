...
<div class="mx-auto max-w-4xl bg-white py-5 px-12 lg:px-24 shadow-xl mb-24">
    <form action="{{route('gerente.solcomisiones')}}" method="POST" autocomplete="off">
@csrf
    ...
    ?>
        ...
        <div class="-mx-3 md:flex mb-6">
          <div class="md:w-1/2 px-3 mb-6 md:mb-0">
            ...
            <input class="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" id="fechainicio" name="fechainicio" type="date" >
          ...
          <div class="md:w-1/2 px-3">
            ...
            <input class="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" id="fechafin" name="fechafin" type="date" >
          </div>
        </div>
