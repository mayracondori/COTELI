      ...
      <div class="container w-full md:w-4/5 xl:w-4/5  mx-auto px-2">
			...
			<!--Title-->
                ...
                <div class="text-center">
                    <p class="text-2xl text-purple-700 text-opacity-75">MIS SOLICITUDES ACEPTADAS</p>
                </div>
...
FROM usuario AS u, solicitud AS s, tiposolicitud AS t, tipoexcepcion AS te, opcioneslista AS o WHERE s.estado = '1' AND s.id_usuario = u.id
